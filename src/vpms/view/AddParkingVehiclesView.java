...
import vpms.controller.AddParkingVehiclesController;

/**
 *
 * @author PRABHASH
 */
public class AddParkingVehiclesView extends javax.swing.JFrame {

    /**
     * Creates new form AddParkingVehiclesView
     */
    public AddParkingVehiclesView() {
        initComponents();
    }
    ...
    private void btnSaveVehicleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveVehicleActionPerformed
     AddParkingVehiclesController controller = new AddParkingVehiclesController(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddParkingVehiclesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddParkingVehiclesView().setVisible(true);
            }
        });
    }
